...
public:
	...
	virtual void vertex(const double* pos, unsigned int color, const double* uv);
	virtual void vertex(const double x, const double y, const double z, unsigned int color, const double u, const double v);
	virtual void end();
};
